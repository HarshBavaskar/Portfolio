...
export const projects = [
  ...
  },
  {
    ...
    text: 'A real-time cloudburst early-warning system. MobileNetV2 reads the sky, an LSTM models how it is escalating, and an ensemble risk score pushes alerts to nearby authorities and citizens’ phones.',
    role: 'Lead AI engineer',
    stack: ['MobileNetV2', 'LSTM', 'Python', 'Flutter', 'Push alerts'],
    metric: ['CNN + LSTM', 'ensemble risk scoring'],
    href: 'https://github.com/HarshBavaskar/Polaris',
    hint: 'Move to seed clouds',
  },
  {
    id: 'airo',
    name: 'AIRO Bot',
